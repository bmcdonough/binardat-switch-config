...
Example:
    Basic usage with defaults (192.168.2.1, admin/admin):
    ...
    def _navigate_to_ssh_config(self) -> bool:
        ...
        try:
            ...
            if monitor_mgmt_parent is None:
                ...
                with open("debug_ssh_after_login.html", "w") as f:
                    f.write(self.driver.page_source)
                print("Page source saved to debug_ssh_after_login.html")
                return False
            ...
            try:
                ...
                # Save the SSH config page for reference
                with open("debug_ssh_config_loaded.html", "w") as f:
                    f.write(self.driver.page_source)
                print("SSH config page saved to debug_ssh_config_loaded.html")
        ...
        try:
            ...
            if enable_field.tag_name == "input" and enable_field.get_attribute("type") == "checkbox":
                ...
                if not enable_field.is_selected():
                    ...
                    # Checkbox may be hidden by CSS, use JavaScript to click it
                    # Or click the associated label which is visible
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Use defaults (192.168.2.1, admin/admin, port 22)
  python enable_ssh_selenium.py
  ...
  # Custom credentials
  python enable_ssh_selenium.py --username admin --password mypass
  ...
  python enable_ssh_selenium.py \\
    ...
    parser.add_argument(
        '--switch-ip',
        default='192.168.2.1',
        help='IP address of the switch (default: 192.168.2.1)'
    )
    parser.add_argument(
        '-u', '--username',
        default='admin',
