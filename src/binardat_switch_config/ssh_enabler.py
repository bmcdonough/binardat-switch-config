"""SSH enablement automation for Binardat switches.

This module provides classes and functions for enabling SSH on Binardat
switches through automated web interface interaction using Selenium.
"""
